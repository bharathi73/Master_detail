		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#comtechmmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtechmmasterdetail-display": {
								"semanticObject": "comtechmmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.techm.masterdetail",
									"url": sap.ui.require.toUrl("com/techm/masterdetail")
								}
							}
						}
					}
